 ...
 * const beginGoodTimes = createAction(BEGIN_GOOD_TIMES);
 */
var createErrorAction = exports.createErrorAction = function createErrorAction(actionType) {
  var message = arguments.length <= 1 || arguments[1] === undefined ? 'An error occurred' : arguments[1];
  return function () {
    var payload = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
    return { type: actionType, message: message, payload: payload, error: true };
  };
};
...
var fetchCallback = exports.fetchCallback = function fetchCallback(func) {
  return (0, _ramda.compose)((0, _ramda.converge)(func, [safeData, safeMeta]), statusFilter);
};
