...
var safeType = (0, _ramda.propOr)('', 'type');
 ...
 * //=> false
 */
var actionTypeIs = exports.actionTypeIs = (0, _ramda.converge)(_ramda.equals, [(0, _ramda.nthArg)(1), safeType]);

var actionTypeIsC = exports.actionTypeIsC = (0, _ramda.curry)(function (action, actionType) {
  return (0, _ramda.compose)((0, _ramda.equals)(actionType), safeType)(action);
});
